...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/rest/testData/">单表列表</a></li>
		<li class="active"><a href="${ctx}/rest/testData/form?id=${testData.id}">单表<shiro:hasPermission name="rest:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="rest:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/rest/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="rest:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
